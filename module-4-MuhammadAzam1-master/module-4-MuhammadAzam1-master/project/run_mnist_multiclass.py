...
class Network(minitorch.Module):
    ...
    def forward(self, x):
        ...
        a = minitorch.avgpool2d(self.out, (4, 4))
        a = a.view(BATCH, 392)
        a = self.layer3.forward(a).relu()
        a = minitorch.nn.dropout(a, 0.25, ignore=self.mode == "eval")
        a = self.layer4.forward(a)
        return minitorch.nn.logsoftmax(a, 1)
